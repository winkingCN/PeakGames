...
internal abstract class PHEKPHCPKLA
{
	...
	{
		if (AMFCENFNAJJ.SignValue < 0 || AMFCENFNAJJ.BitLength > 192)
		{
	...
	public static void BMEIFJDODCF(uint[] AMFCENFNAJJ, uint[] CNLILOEEBOJ, uint[] JMNJPLAGDDJ)
	{
		...
		ulong num7 = 0uL;
		ulong num8 = AMFCENFNAJJ[0];
		num7 += num8 * num;
		JMNJPLAGDDJ[0] = (uint)num7;
		num7 >>= 32;
		num7 += num8 * num2;
		JMNJPLAGDDJ[1] = (uint)num7;
		num7 >>= 32;
		num7 += num8 * num3;
		JMNJPLAGDDJ[2] = (uint)num7;
		num7 >>= 32;
		num7 += num8 * num4;
		JMNJPLAGDDJ[3] = (uint)num7;
		num7 >>= 32;
		num7 += num8 * num5;
		JMNJPLAGDDJ[4] = (uint)num7;
		num7 >>= 32;
		num7 += num8 * num6;
		JMNJPLAGDDJ[5] = (uint)num7;
		num7 >>= 32;
		JMNJPLAGDDJ[6] = (uint)num7;
		for (int i = 1; i < 6; i++)
		{
			ulong num9 = 0uL;
	...
	public static void BMEIFJDODCF(uint[] AMFCENFNAJJ, int ABBPDEOGNFE, uint[] CNLILOEEBOJ, int HGNFOMNFIDD, uint[] JMNJPLAGDDJ, int IHCMHKCMELO)
	{
		...
		ulong num7 = 0uL;
		ulong num8 = AMFCENFNAJJ[ABBPDEOGNFE];
		num7 += num8 * num;
		...
		num7 >>= 32;
		JMNJPLAGDDJ[IHCMHKCMELO + 6] = (uint)num7;
		for (int i = 1; i < 6; i++)
		{
			IHCMHKCMELO++;
			ulong num9 = 0uL;
	...
	public static uint HHMEIAJHDJM(uint[] AMFCENFNAJJ, uint[] CNLILOEEBOJ, uint[] JMNJPLAGDDJ)
	{
		...
		for (int i = 0; i < 6; i++)
		{
			...
			num8 >>= 32;
			num8 += num9 * num6 + JMNJPLAGDDJ[i + 5];
			JMNJPLAGDDJ[i + 5] = (uint)num8;
			num8 >>= 32;
			num8 += num7 + JMNJPLAGDDJ[i + 6];
			JMNJPLAGDDJ[i + 6] = (uint)num8;
			num7 = num8 >> 32;
		}
		return (uint)num7;
	}
	...
	public static uint HHMEIAJHDJM(uint[] AMFCENFNAJJ, int ABBPDEOGNFE, uint[] CNLILOEEBOJ, int HGNFOMNFIDD, uint[] JMNJPLAGDDJ, int IHCMHKCMELO)
	{
		...
		for (int i = 0; i < 6; i++)
		{
			...
			num8 >>= 32;
			num8 += num9 * num6 + JMNJPLAGDDJ[IHCMHKCMELO + 5];
			JMNJPLAGDDJ[IHCMHKCMELO + 5] = (uint)num8;
			num8 >>= 32;
			num8 += num7 + JMNJPLAGDDJ[IHCMHKCMELO + 6];
	...
	public static uint IAPOGGJEDPC(uint AMFCENFNAJJ, uint[] IKEIELCEKPD, int GFPDLNKAGPD, uint[] JMNJPLAGDDJ, int IHCMHKCMELO)
	{
		...
		num >>= 32;
		num += num2 * IKEIELCEKPD[GFPDLNKAGPD + 5] + JMNJPLAGDDJ[IHCMHKCMELO + 5];
		JMNJPLAGDDJ[IHCMHKCMELO + 5] = (uint)num;
		num >>= 32;
		return (uint)num;
	}
	...
	public static uint CDNAAKLGHLD(uint AMFCENFNAJJ, ulong CNLILOEEBOJ, uint[] IGNEOOOFEMO, int NDAAKFPMLOL)
	{
		...
		IGNEOOOFEMO[NDAAKFPMLOL + 3] = (uint)num;
		num >>= 32;
		return (num != 0) ? BCMDHIIJKJE.DKCBNAFCCMF(6, IGNEOOOFEMO, NDAAKFPMLOL, 4) : 0u;
	}
	...
	public static uint KDGIJAIDNND(uint AMFCENFNAJJ, uint CNLILOEEBOJ, uint[] IGNEOOOFEMO, int NDAAKFPMLOL)
	{
		...
		IGNEOOOFEMO[NDAAKFPMLOL + 2] = (uint)num;
		num >>= 32;
		return (num != 0) ? BCMDHIIJKJE.DKCBNAFCCMF(6, IGNEOOOFEMO, NDAAKFPMLOL, 3) : 0u;
	}
	...
	public static void MIOEHGDPGAG(uint[] AMFCENFNAJJ, uint[] JMNJPLAGDDJ)
	{
		...
		num2 = num11 >> 31;
		num11 = JMNJPLAGDDJ[11] + (uint)(int)(num23 >> 32);
	...
	public static void MIOEHGDPGAG(uint[] AMFCENFNAJJ, int ABBPDEOGNFE, uint[] JMNJPLAGDDJ, int IHCMHKCMELO)
	{
		...
		num2 = num11 >> 31;
		num11 = JMNJPLAGDDJ[IHCMHKCMELO + 11] + (uint)(int)(num23 >> 32);
	...
	public static BigInteger DOJBPIFPALJ(uint[] AMFCENFNAJJ)
	{
		...
		for (int i = 0; i < 6; i++)
		{
			...
			if (num != 0)
			{
				PGOKFBKEOAB.MPMAFPANDLC(num, array, 5 - i << 2);
			}
		}
	...
	public static BigInteger CLJANJOEBFJ(ulong[] AMFCENFNAJJ)
	{
		...
		for (int i = 0; i < 3; i++)
		{
			...
			if (num != 0)
			{
				PGOKFBKEOAB.LHKOONEHKNH(num, array, 2 - i << 3);
			}
		}
		return new BigInteger(1, array);
	}
