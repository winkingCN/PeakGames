...
{
	public class SodaBottleParticlePlayer : ParticlePlayer
	{
		private static readonly Color NMOBCJIGDFB = new Color(1f, 1f, 0.22f);

		private static readonly Color CMELIKAKIJM = new Color(1f, 0f, 0f);

		private static readonly Color JAFKHAAGNMC = new Color(0f, 0.62f, 1f);
