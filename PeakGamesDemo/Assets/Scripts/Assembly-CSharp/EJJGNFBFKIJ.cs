...
internal abstract class EJJGNFBFKIJ
{
	...
	{
		if (AMFCENFNAJJ.SignValue < 0 || AMFCENFNAJJ.BitLength > 160)
		{
	...
	public static void BMEIFJDODCF(uint[] AMFCENFNAJJ, uint[] CNLILOEEBOJ, uint[] JMNJPLAGDDJ)
	{
		...
		ulong num6 = 0uL;
		ulong num7 = AMFCENFNAJJ[0];
		num6 += num7 * num;
		JMNJPLAGDDJ[0] = (uint)num6;
		num6 >>= 32;
		num6 += num7 * num2;
		JMNJPLAGDDJ[1] = (uint)num6;
		num6 >>= 32;
		num6 += num7 * num3;
		JMNJPLAGDDJ[2] = (uint)num6;
		num6 >>= 32;
		num6 += num7 * num4;
		JMNJPLAGDDJ[3] = (uint)num6;
		num6 >>= 32;
		num6 += num7 * num5;
		JMNJPLAGDDJ[4] = (uint)num6;
		num6 >>= 32;
		JMNJPLAGDDJ[5] = (uint)num6;
		for (int i = 1; i < 5; i++)
		{
			ulong num8 = 0uL;
			ulong num9 = AMFCENFNAJJ[i];
			num8 += num9 * num + JMNJPLAGDDJ[i];
			JMNJPLAGDDJ[i] = (uint)num8;
			num8 >>= 32;
			num8 += num9 * num2 + JMNJPLAGDDJ[i + 1];
			JMNJPLAGDDJ[i + 1] = (uint)num8;
			num8 >>= 32;
			num8 += num9 * num3 + JMNJPLAGDDJ[i + 2];
			JMNJPLAGDDJ[i + 2] = (uint)num8;
			num8 >>= 32;
			num8 += num9 * num4 + JMNJPLAGDDJ[i + 3];
			JMNJPLAGDDJ[i + 3] = (uint)num8;
			num8 >>= 32;
			num8 += num9 * num5 + JMNJPLAGDDJ[i + 4];
			JMNJPLAGDDJ[i + 4] = (uint)num8;
			num8 >>= 32;
			JMNJPLAGDDJ[i + 5] = (uint)num8;
		}
	}
	...
	public static void BMEIFJDODCF(uint[] AMFCENFNAJJ, int ABBPDEOGNFE, uint[] CNLILOEEBOJ, int HGNFOMNFIDD, uint[] JMNJPLAGDDJ, int IHCMHKCMELO)
	{
		...
		ulong num6 = 0uL;
		ulong num7 = AMFCENFNAJJ[ABBPDEOGNFE];
		num6 += num7 * num;
		JMNJPLAGDDJ[IHCMHKCMELO] = (uint)num6;
		num6 >>= 32;
		num6 += num7 * num2;
		JMNJPLAGDDJ[IHCMHKCMELO + 1] = (uint)num6;
		num6 >>= 32;
		num6 += num7 * num3;
		JMNJPLAGDDJ[IHCMHKCMELO + 2] = (uint)num6;
		num6 >>= 32;
		num6 += num7 * num4;
		JMNJPLAGDDJ[IHCMHKCMELO + 3] = (uint)num6;
		num6 >>= 32;
		num6 += num7 * num5;
		JMNJPLAGDDJ[IHCMHKCMELO + 4] = (uint)num6;
		num6 >>= 32;
		JMNJPLAGDDJ[IHCMHKCMELO + 5] = (uint)num6;
		for (int i = 1; i < 5; i++)
		{
			IHCMHKCMELO++;
			ulong num8 = 0uL;
			ulong num9 = AMFCENFNAJJ[ABBPDEOGNFE + i];
			num8 += num9 * num + JMNJPLAGDDJ[IHCMHKCMELO];
			JMNJPLAGDDJ[IHCMHKCMELO] = (uint)num8;
			num8 >>= 32;
			num8 += num9 * num2 + JMNJPLAGDDJ[IHCMHKCMELO + 1];
			JMNJPLAGDDJ[IHCMHKCMELO + 1] = (uint)num8;
			num8 >>= 32;
			num8 += num9 * num3 + JMNJPLAGDDJ[IHCMHKCMELO + 2];
			JMNJPLAGDDJ[IHCMHKCMELO + 2] = (uint)num8;
			num8 >>= 32;
			num8 += num9 * num4 + JMNJPLAGDDJ[IHCMHKCMELO + 3];
			JMNJPLAGDDJ[IHCMHKCMELO + 3] = (uint)num8;
			num8 >>= 32;
			num8 += num9 * num5 + JMNJPLAGDDJ[IHCMHKCMELO + 4];
	...
	public static uint HHMEIAJHDJM(uint[] AMFCENFNAJJ, uint[] CNLILOEEBOJ, uint[] JMNJPLAGDDJ)
	{
		...
		{
			ulong num7 = 0uL;
			ulong num8 = AMFCENFNAJJ[i];
			num7 += num8 * num + JMNJPLAGDDJ[i];
			JMNJPLAGDDJ[i] = (uint)num7;
			num7 >>= 32;
			num7 += num8 * num2 + JMNJPLAGDDJ[i + 1];
			JMNJPLAGDDJ[i + 1] = (uint)num7;
			num7 >>= 32;
			num7 += num8 * num3 + JMNJPLAGDDJ[i + 2];
			JMNJPLAGDDJ[i + 2] = (uint)num7;
			num7 >>= 32;
			num7 += num8 * num4 + JMNJPLAGDDJ[i + 3];
			JMNJPLAGDDJ[i + 3] = (uint)num7;
			num7 >>= 32;
			num7 += num8 * num5 + JMNJPLAGDDJ[i + 4];
			JMNJPLAGDDJ[i + 4] = (uint)num7;
			num7 >>= 32;
			num7 += num6 + JMNJPLAGDDJ[i + 5];
			JMNJPLAGDDJ[i + 5] = (uint)num7;
			num6 = num7 >> 32;
		}
		return (uint)num6;
	}
	...
	public static uint HHMEIAJHDJM(uint[] AMFCENFNAJJ, int ABBPDEOGNFE, uint[] CNLILOEEBOJ, int HGNFOMNFIDD, uint[] JMNJPLAGDDJ, int IHCMHKCMELO)
	{
		...
		{
			ulong num7 = 0uL;
			ulong num8 = AMFCENFNAJJ[ABBPDEOGNFE + i];
			num7 += num8 * num + JMNJPLAGDDJ[IHCMHKCMELO];
			JMNJPLAGDDJ[IHCMHKCMELO] = (uint)num7;
			num7 >>= 32;
			num7 += num8 * num2 + JMNJPLAGDDJ[IHCMHKCMELO + 1];
			JMNJPLAGDDJ[IHCMHKCMELO + 1] = (uint)num7;
			num7 >>= 32;
			num7 += num8 * num3 + JMNJPLAGDDJ[IHCMHKCMELO + 2];
			JMNJPLAGDDJ[IHCMHKCMELO + 2] = (uint)num7;
			num7 >>= 32;
			num7 += num8 * num4 + JMNJPLAGDDJ[IHCMHKCMELO + 3];
			JMNJPLAGDDJ[IHCMHKCMELO + 3] = (uint)num7;
			num7 >>= 32;
			num7 += num8 * num5 + JMNJPLAGDDJ[IHCMHKCMELO + 4];
			JMNJPLAGDDJ[IHCMHKCMELO + 4] = (uint)num7;
			num7 >>= 32;
			num7 += num6 + JMNJPLAGDDJ[IHCMHKCMELO + 5];
			JMNJPLAGDDJ[IHCMHKCMELO + 5] = (uint)num7;
			num6 = num7 >> 32;
			IHCMHKCMELO++;
		}
		return (uint)num6;
	...
	public static uint IAPOGGJEDPC(uint AMFCENFNAJJ, uint[] IKEIELCEKPD, int GFPDLNKAGPD, uint[] JMNJPLAGDDJ, int IHCMHKCMELO)
	{
		ulong num = 0uL;
		ulong num2 = AMFCENFNAJJ;
		num += num2 * IKEIELCEKPD[GFPDLNKAGPD] + JMNJPLAGDDJ[IHCMHKCMELO];
		JMNJPLAGDDJ[IHCMHKCMELO] = (uint)num;
		num >>= 32;
		num += num2 * IKEIELCEKPD[GFPDLNKAGPD + 1] + JMNJPLAGDDJ[IHCMHKCMELO + 1];
		JMNJPLAGDDJ[IHCMHKCMELO + 1] = (uint)num;
		num >>= 32;
		num += num2 * IKEIELCEKPD[GFPDLNKAGPD + 2] + JMNJPLAGDDJ[IHCMHKCMELO + 2];
		JMNJPLAGDDJ[IHCMHKCMELO + 2] = (uint)num;
		num >>= 32;
		num += num2 * IKEIELCEKPD[GFPDLNKAGPD + 3] + JMNJPLAGDDJ[IHCMHKCMELO + 3];
		JMNJPLAGDDJ[IHCMHKCMELO + 3] = (uint)num;
		num >>= 32;
		num += num2 * IKEIELCEKPD[GFPDLNKAGPD + 4] + JMNJPLAGDDJ[IHCMHKCMELO + 4];
		JMNJPLAGDDJ[IHCMHKCMELO + 4] = (uint)num;
		num >>= 32;
		return (uint)num;
	}
	...
	public static uint CDNAAKLGHLD(uint AMFCENFNAJJ, ulong CNLILOEEBOJ, uint[] IGNEOOOFEMO, int NDAAKFPMLOL)
	{
		...
		IGNEOOOFEMO[NDAAKFPMLOL + 3] = (uint)num;
		num >>= 32;
		return (num != 0) ? BCMDHIIJKJE.DKCBNAFCCMF(5, IGNEOOOFEMO, NDAAKFPMLOL, 4) : 0u;
	}
	...
	public static uint KDGIJAIDNND(uint AMFCENFNAJJ, uint CNLILOEEBOJ, uint[] IGNEOOOFEMO, int NDAAKFPMLOL)
	{
		...
		IGNEOOOFEMO[NDAAKFPMLOL + 2] = (uint)num;
		num >>= 32;
		return (num != 0) ? BCMDHIIJKJE.DKCBNAFCCMF(5, IGNEOOOFEMO, NDAAKFPMLOL, 3) : 0u;
	}
	...
	public static uint DHNHBEHAKGG(uint AMFCENFNAJJ, uint CNLILOEEBOJ, uint[] IGNEOOOFEMO, int NDAAKFPMLOL)
	{
		ulong num = 0uL;
		ulong num2 = AMFCENFNAJJ;
		ulong num3 = CNLILOEEBOJ;
		num += num3 * num2 + IGNEOOOFEMO[NDAAKFPMLOL];
		IGNEOOOFEMO[NDAAKFPMLOL] = (uint)num;
		num >>= 32;
		num += IGNEOOOFEMO[NDAAKFPMLOL + 1];
		IGNEOOOFEMO[NDAAKFPMLOL + 1] = (uint)num;
		num >>= 32;
		return (num != 0) ? BCMDHIIJKJE.DKCBNAFCCMF(5, IGNEOOOFEMO, NDAAKFPMLOL, 2) : 0u;
	}
	...
	public static void MIOEHGDPGAG(uint[] AMFCENFNAJJ, uint[] JMNJPLAGDDJ)
	{
		...
		num2 = num11 >> 31;
		num11 = JMNJPLAGDDJ[9] + (uint)(int)(num20 >> 32);
	...
	public static void MIOEHGDPGAG(uint[] AMFCENFNAJJ, int ABBPDEOGNFE, uint[] JMNJPLAGDDJ, int IHCMHKCMELO)
	{
		...
		num2 = num11 >> 31;
		num11 = JMNJPLAGDDJ[IHCMHKCMELO + 9] + (uint)(int)(num20 >> 32);
	...
	public static BigInteger DOJBPIFPALJ(uint[] AMFCENFNAJJ)
	{
		...
		for (int i = 0; i < 5; i++)
		{
			...
			if (num != 0)
			{
				PGOKFBKEOAB.MPMAFPANDLC(num, array, 4 - i << 2);
			}
		}
