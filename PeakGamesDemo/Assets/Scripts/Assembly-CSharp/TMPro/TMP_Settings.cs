...
namespace TMPro
{
	...
	{
		public class COMEJCFDPPI
		{
			public Dictionary<int, char> INNIIOIHLLF;

			public Dictionary<int, char> GJEMIJJBCOL;
		}
		...
		[SerializeField]
		private COMEJCFDPPI m_linebreakingRules;
		...
		public static COMEJCFDPPI linebreakingRules
		{
			get
			{
		...
		public static TMP_Settings BFCDKEKLEJF()
		{
			if (s_Instance == null)
			{
		...
		public static TMP_Settings NNFJPEAOHCN()
		{
			if (instance == null)
			{
				return null;
		...
		public static TMP_FontAsset AOHOHMFHHDF()
		{
			if (instance == null)
			{
				return null;
		...
		public static TMP_SpriteAsset LLIAHFFFOIH()
		{
			if (instance == null)
			{
				return null;
		...
		public static TMP_StyleSheet LJPEENPCLLG()
		{
			if (instance == null)
			{
				return null;
		...
		public static void BCEHNPDPBMI()
		{
			if (!(instance == null))
			{
				if (s_Instance.m_linebreakingRules == null)
				{
					s_Instance.m_linebreakingRules = new COMEJCFDPPI();
				}
				s_Instance.m_linebreakingRules.INNIIOIHLLF = NIJDCJFEJDC(s_Instance.m_leadingCharacters);
				s_Instance.m_linebreakingRules.GJEMIJJBCOL = NIJDCJFEJDC(s_Instance.m_followingCharacters);
			}
		}

		private static Dictionary<int, char> NIJDCJFEJDC(TextAsset CANPMPPLMHJ)
		{
			Dictionary<int, char> dictionary = new Dictionary<int, char>();
			string text = CANPMPPLMHJ.text;
