...
internal abstract class AKOICJCJNFB
{
	...
	public static uint JEACJNAKLDJ(uint[] AMFCENFNAJJ, uint[] CNLILOEEBOJ, uint[] IGNEOOOFEMO)
	{
		...
		num >>= 32;
		num += (ulong)((long)AMFCENFNAJJ[7] + (long)CNLILOEEBOJ[7]);
	...
	public static uint JEACJNAKLDJ(uint[] AMFCENFNAJJ, int ABBPDEOGNFE, uint[] CNLILOEEBOJ, int HGNFOMNFIDD, uint[] IGNEOOOFEMO, int NDAAKFPMLOL)
	{
		...
		num >>= 32;
		num += (ulong)((long)AMFCENFNAJJ[ABBPDEOGNFE + 7] + (long)CNLILOEEBOJ[HGNFOMNFIDD + 7]);
		IGNEOOOFEMO[NDAAKFPMLOL + 7] = (uint)num;
		num >>= 32;
		return (uint)num;
	}
	...
	public static uint FIBDFFPCDGC(uint[] AMFCENFNAJJ, uint[] CNLILOEEBOJ, uint[] IGNEOOOFEMO)
	{
		...
		IGNEOOOFEMO[6] = (uint)num;
		num >>= 32;
		num += (ulong)((long)AMFCENFNAJJ[7] + (long)CNLILOEEBOJ[7] + IGNEOOOFEMO[7]);
		IGNEOOOFEMO[7] = (uint)num;
		num >>= 32;
		return (uint)num;
	}
	...
	public static uint FIBDFFPCDGC(uint[] AMFCENFNAJJ, int ABBPDEOGNFE, uint[] CNLILOEEBOJ, int HGNFOMNFIDD, uint[] IGNEOOOFEMO, int NDAAKFPMLOL)
	{
		...
		IGNEOOOFEMO[NDAAKFPMLOL + 6] = (uint)num;
		num >>= 32;
		num += (ulong)((long)AMFCENFNAJJ[ABBPDEOGNFE + 7] + (long)CNLILOEEBOJ[HGNFOMNFIDD + 7] + IGNEOOOFEMO[NDAAKFPMLOL + 7]);
		IGNEOOOFEMO[NDAAKFPMLOL + 7] = (uint)num;
		num >>= 32;
		return (uint)num;
	}
	...
	public static uint MAALDEFJPJA(uint[] AMFCENFNAJJ, uint[] IGNEOOOFEMO)
	{
		...
		IGNEOOOFEMO[6] = (uint)num;
		num >>= 32;
		num += (ulong)((long)AMFCENFNAJJ[7] + (long)IGNEOOOFEMO[7]);
		IGNEOOOFEMO[7] = (uint)num;
		num >>= 32;
		return (uint)num;
	}
	...
	public static uint MAALDEFJPJA(uint[] AMFCENFNAJJ, int ABBPDEOGNFE, uint[] IGNEOOOFEMO, int NDAAKFPMLOL, uint EFEEMAAFCMH)
	{
		...
		IGNEOOOFEMO[NDAAKFPMLOL + 6] = (uint)num;
		num >>= 32;
		num += (ulong)((long)AMFCENFNAJJ[ABBPDEOGNFE + 7] + (long)IGNEOOOFEMO[NDAAKFPMLOL + 7]);
		IGNEOOOFEMO[NDAAKFPMLOL + 7] = (uint)num;
		num >>= 32;
		return (uint)num;
	}
	...
	public static uint HFHBOBLBLDH(uint[] OJOAGEHFPNP, int AMLHEOCHLKC, uint[] AAIEJDNAODP, int FOKCGBLKIGD)
	{
		...
		num >>= 32;
		num += (ulong)((long)OJOAGEHFPNP[AMLHEOCHLKC + 7] + (long)AAIEJDNAODP[FOKCGBLKIGD + 7]);
		OJOAGEHFPNP[AMLHEOCHLKC + 7] = (uint)num;
		AAIEJDNAODP[FOKCGBLKIGD + 7] = (uint)num;
		num >>= 32;
		return (uint)num;
	}
	...
	{
		if (AMFCENFNAJJ.SignValue < 0 || AMFCENFNAJJ.BitLength > 256)
		{
	...
	public static uint DOFLEKCIDCA(uint[] AMFCENFNAJJ, int DCBMAGOBBEC)
	{
		...
		if ((DCBMAGOBBEC & 0xFF) != DCBMAGOBBEC)
		{
			return 0u;
		}
	...
	public static void BMEIFJDODCF(uint[] AMFCENFNAJJ, uint[] CNLILOEEBOJ, uint[] JMNJPLAGDDJ)
	{
		...
		ulong num8 = CNLILOEEBOJ[7];
		ulong num9 = 0uL;
		ulong num10 = AMFCENFNAJJ[0];
		num9 += num10 * num;
		JMNJPLAGDDJ[0] = (uint)num9;
		num9 >>= 32;
		num9 += num10 * num2;
		JMNJPLAGDDJ[1] = (uint)num9;
		num9 >>= 32;
		num9 += num10 * num3;
		JMNJPLAGDDJ[2] = (uint)num9;
		num9 >>= 32;
		num9 += num10 * num4;
		JMNJPLAGDDJ[3] = (uint)num9;
		num9 >>= 32;
		num9 += num10 * num5;
		JMNJPLAGDDJ[4] = (uint)num9;
		num9 >>= 32;
		num9 += num10 * num6;
		JMNJPLAGDDJ[5] = (uint)num9;
		num9 >>= 32;
		num9 += num10 * num7;
		JMNJPLAGDDJ[6] = (uint)num9;
		num9 >>= 32;
		num9 += num10 * num8;
		JMNJPLAGDDJ[7] = (uint)num9;
		num9 >>= 32;
		JMNJPLAGDDJ[8] = (uint)num9;
		for (int i = 1; i < 8; i++)
		{
			ulong num11 = 0uL;
			ulong num12 = AMFCENFNAJJ[i];
			num11 += num12 * num + JMNJPLAGDDJ[i];
			JMNJPLAGDDJ[i] = (uint)num11;
			num11 >>= 32;
			num11 += num12 * num2 + JMNJPLAGDDJ[i + 1];
			JMNJPLAGDDJ[i + 1] = (uint)num11;
			num11 >>= 32;
			num11 += num12 * num3 + JMNJPLAGDDJ[i + 2];
			JMNJPLAGDDJ[i + 2] = (uint)num11;
			num11 >>= 32;
			num11 += num12 * num4 + JMNJPLAGDDJ[i + 3];
			JMNJPLAGDDJ[i + 3] = (uint)num11;
			num11 >>= 32;
			num11 += num12 * num5 + JMNJPLAGDDJ[i + 4];
			JMNJPLAGDDJ[i + 4] = (uint)num11;
			num11 >>= 32;
			num11 += num12 * num6 + JMNJPLAGDDJ[i + 5];
			JMNJPLAGDDJ[i + 5] = (uint)num11;
			num11 >>= 32;
			num11 += num12 * num7 + JMNJPLAGDDJ[i + 6];
			JMNJPLAGDDJ[i + 6] = (uint)num11;
			num11 >>= 32;
			num11 += num12 * num8 + JMNJPLAGDDJ[i + 7];
			JMNJPLAGDDJ[i + 7] = (uint)num11;
			num11 >>= 32;
			JMNJPLAGDDJ[i + 8] = (uint)num11;
		}
	}
	...
	public static void BMEIFJDODCF(uint[] AMFCENFNAJJ, int ABBPDEOGNFE, uint[] CNLILOEEBOJ, int HGNFOMNFIDD, uint[] JMNJPLAGDDJ, int IHCMHKCMELO)
	{
		...
		ulong num8 = CNLILOEEBOJ[HGNFOMNFIDD + 7];
		ulong num9 = 0uL;
		ulong num10 = AMFCENFNAJJ[ABBPDEOGNFE];
		num9 += num10 * num;
		...
		num9 >>= 32;
		JMNJPLAGDDJ[IHCMHKCMELO + 8] = (uint)num9;
		for (int i = 1; i < 8; i++)
		{
			IHCMHKCMELO++;
			ulong num11 = 0uL;
			ulong num12 = AMFCENFNAJJ[ABBPDEOGNFE + i];
			num11 += num12 * num + JMNJPLAGDDJ[IHCMHKCMELO];
			JMNJPLAGDDJ[IHCMHKCMELO] = (uint)num11;
			num11 >>= 32;
			num11 += num12 * num2 + JMNJPLAGDDJ[IHCMHKCMELO + 1];
			JMNJPLAGDDJ[IHCMHKCMELO + 1] = (uint)num11;
			num11 >>= 32;
			num11 += num12 * num3 + JMNJPLAGDDJ[IHCMHKCMELO + 2];
			JMNJPLAGDDJ[IHCMHKCMELO + 2] = (uint)num11;
			num11 >>= 32;
			num11 += num12 * num4 + JMNJPLAGDDJ[IHCMHKCMELO + 3];
			JMNJPLAGDDJ[IHCMHKCMELO + 3] = (uint)num11;
			num11 >>= 32;
			num11 += num12 * num5 + JMNJPLAGDDJ[IHCMHKCMELO + 4];
			JMNJPLAGDDJ[IHCMHKCMELO + 4] = (uint)num11;
			num11 >>= 32;
			num11 += num12 * num6 + JMNJPLAGDDJ[IHCMHKCMELO + 5];
			JMNJPLAGDDJ[IHCMHKCMELO + 5] = (uint)num11;
			num11 >>= 32;
			num11 += num12 * num7 + JMNJPLAGDDJ[IHCMHKCMELO + 6];
			JMNJPLAGDDJ[IHCMHKCMELO + 6] = (uint)num11;
			num11 >>= 32;
			num11 += num12 * num8 + JMNJPLAGDDJ[IHCMHKCMELO + 7];
			JMNJPLAGDDJ[IHCMHKCMELO + 7] = (uint)num11;
			num11 >>= 32;
			JMNJPLAGDDJ[IHCMHKCMELO + 8] = (uint)num11;
		}
	}
	...
	public static uint HHMEIAJHDJM(uint[] AMFCENFNAJJ, uint[] CNLILOEEBOJ, uint[] JMNJPLAGDDJ)
	{
		...
		for (int i = 0; i < 8; i++)
		{
			...
			num10 >>= 32;
			num10 += num11 * num8 + JMNJPLAGDDJ[i + 7];
			JMNJPLAGDDJ[i + 7] = (uint)num10;
			num10 >>= 32;
			num10 += num9 + JMNJPLAGDDJ[i + 8];
			JMNJPLAGDDJ[i + 8] = (uint)num10;
			num9 = num10 >> 32;
		}
		return (uint)num9;
	}
	...
	public static uint HHMEIAJHDJM(uint[] AMFCENFNAJJ, int ABBPDEOGNFE, uint[] CNLILOEEBOJ, int HGNFOMNFIDD, uint[] JMNJPLAGDDJ, int IHCMHKCMELO)
	{
		...
		for (int i = 0; i < 8; i++)
		{
			...
			num10 >>= 32;
			num10 += num11 * num8 + JMNJPLAGDDJ[IHCMHKCMELO + 7];
			JMNJPLAGDDJ[IHCMHKCMELO + 7] = (uint)num10;
			num10 >>= 32;
			num10 += num9 + JMNJPLAGDDJ[IHCMHKCMELO + 8];
			JMNJPLAGDDJ[IHCMHKCMELO + 8] = (uint)num10;
			num9 = num10 >> 32;
			IHCMHKCMELO++;
		}
		return (uint)num9;
	...
	public static ulong FGMIACGNJLN(uint PHFLBLJJMLI, uint[] AMFCENFNAJJ, int ABBPDEOGNFE, uint[] CNLILOEEBOJ, int HGNFOMNFIDD, uint[] IGNEOOOFEMO, int NDAAKFPMLOL)
	{
		...
		IGNEOOOFEMO[NDAAKFPMLOL + 6] = (uint)num;
		num >>= 32;
		ulong num10 = AMFCENFNAJJ[ABBPDEOGNFE + 7];
		num += num2 * num10 + num9 + CNLILOEEBOJ[HGNFOMNFIDD + 7];
		IGNEOOOFEMO[NDAAKFPMLOL + 7] = (uint)num;
		num >>= 32;
		return num + num10;
	}
	...
	public static uint MMHMACBLBPN(uint AMFCENFNAJJ, uint[] CNLILOEEBOJ, uint[] IGNEOOOFEMO)
	{
		...
		IGNEOOOFEMO[6] = (uint)num;
		num >>= 32;
		num += num2 * IGNEOOOFEMO[7] + CNLILOEEBOJ[7];
		IGNEOOOFEMO[7] = (uint)num;
		num >>= 32;
		return (uint)num;
	}
	...
	public static uint HAFIKHOEMNC(uint AMFCENFNAJJ, uint[] CNLILOEEBOJ, int HGNFOMNFIDD, uint[] IGNEOOOFEMO, int NDAAKFPMLOL)
	{
		...
		IGNEOOOFEMO[NDAAKFPMLOL + 6] = (uint)num;
		num >>= 32;
		num += num2 * CNLILOEEBOJ[HGNFOMNFIDD + 7] + IGNEOOOFEMO[NDAAKFPMLOL + 7];
		IGNEOOOFEMO[NDAAKFPMLOL + 7] = (uint)num;
		num >>= 32;
		return (uint)num;
	}
	...
	public static uint CDNAAKLGHLD(uint AMFCENFNAJJ, ulong CNLILOEEBOJ, uint[] IGNEOOOFEMO, int NDAAKFPMLOL)
	{
		...
		IGNEOOOFEMO[NDAAKFPMLOL + 3] = (uint)num;
		num >>= 32;
		return (num != 0) ? BCMDHIIJKJE.DKCBNAFCCMF(8, IGNEOOOFEMO, NDAAKFPMLOL, 4) : 0u;
	}
	...
	public static uint KDGIJAIDNND(uint AMFCENFNAJJ, uint CNLILOEEBOJ, uint[] IGNEOOOFEMO, int NDAAKFPMLOL)
	{
		...
		IGNEOOOFEMO[NDAAKFPMLOL + 2] = (uint)num;
		num >>= 32;
		return (num != 0) ? BCMDHIIJKJE.DKCBNAFCCMF(8, IGNEOOOFEMO, NDAAKFPMLOL, 3) : 0u;
	}
	...
	public static void MIOEHGDPGAG(uint[] AMFCENFNAJJ, uint[] JMNJPLAGDDJ)
	{
		...
		num26 += num25 >> 32;
		num25 &= 0xFFFFFFFFu;
		ulong num27 = AMFCENFNAJJ[7];
		ulong num28 = JMNJPLAGDDJ[13];
		ulong num29 = JMNJPLAGDDJ[14];
		num19 += num27 * num;
		num11 = (uint)num19;
		...
		num2 = num11 >> 31;
		num11 = (uint)num29;
		JMNJPLAGDDJ[14] = (num11 << 1) | num2;
		num2 = num11 >> 31;
		num11 = JMNJPLAGDDJ[15] + (uint)(int)(num29 >> 32);
		JMNJPLAGDDJ[15] = (num11 << 1) | num2;
	}
	...
	public static void MIOEHGDPGAG(uint[] AMFCENFNAJJ, int ABBPDEOGNFE, uint[] JMNJPLAGDDJ, int IHCMHKCMELO)
	{
		...
		num26 += num25 >> 32;
		num25 &= 0xFFFFFFFFu;
		ulong num27 = AMFCENFNAJJ[ABBPDEOGNFE + 7];
		ulong num28 = JMNJPLAGDDJ[IHCMHKCMELO + 13];
		ulong num29 = JMNJPLAGDDJ[IHCMHKCMELO + 14];
		num19 += num27 * num;
		num11 = (uint)num19;
		...
		num2 = num11 >> 31;
		num11 = (uint)num29;
		JMNJPLAGDDJ[IHCMHKCMELO + 14] = (num11 << 1) | num2;
		num2 = num11 >> 31;
		num11 = JMNJPLAGDDJ[IHCMHKCMELO + 15] + (uint)(int)(num29 >> 32);
		JMNJPLAGDDJ[IHCMHKCMELO + 15] = (num11 << 1) | num2;
	}
	...
	public static int EAEONHFLEEN(uint[] AMFCENFNAJJ, uint[] CNLILOEEBOJ, uint[] IGNEOOOFEMO)
	{
		...
		IGNEOOOFEMO[6] = (uint)num;
		num >>= 32;
		num += (long)AMFCENFNAJJ[7] - (long)CNLILOEEBOJ[7];
		IGNEOOOFEMO[7] = (uint)num;
		num >>= 32;
		return (int)num;
	}
	...
	public static int EAEONHFLEEN(uint[] AMFCENFNAJJ, int ABBPDEOGNFE, uint[] CNLILOEEBOJ, int HGNFOMNFIDD, uint[] IGNEOOOFEMO, int NDAAKFPMLOL)
	{
		...
		IGNEOOOFEMO[NDAAKFPMLOL + 6] = (uint)num;
		num >>= 32;
		num += (long)AMFCENFNAJJ[ABBPDEOGNFE + 7] - (long)CNLILOEEBOJ[HGNFOMNFIDD + 7];
		IGNEOOOFEMO[NDAAKFPMLOL + 7] = (uint)num;
		num >>= 32;
		return (int)num;
	}
	...
	public static int DCBNMOKOJHD(uint[] AMFCENFNAJJ, uint[] CNLILOEEBOJ, uint[] IGNEOOOFEMO)
	{
		...
		IGNEOOOFEMO[6] = (uint)num;
		num >>= 32;
		num += (long)IGNEOOOFEMO[7] - (long)AMFCENFNAJJ[7] - CNLILOEEBOJ[7];
		IGNEOOOFEMO[7] = (uint)num;
		num >>= 32;
		return (int)num;
	}
	...
	public static int DKAMAFLMHEJ(uint[] AMFCENFNAJJ, uint[] IGNEOOOFEMO)
	{
		...
		IGNEOOOFEMO[6] = (uint)num;
		num >>= 32;
		num += (long)IGNEOOOFEMO[7] - (long)AMFCENFNAJJ[7];
		IGNEOOOFEMO[7] = (uint)num;
		num >>= 32;
		return (int)num;
	}
	...
	public static int DKAMAFLMHEJ(uint[] AMFCENFNAJJ, int ABBPDEOGNFE, uint[] IGNEOOOFEMO, int NDAAKFPMLOL)
	{
		...
		IGNEOOOFEMO[NDAAKFPMLOL + 6] = (uint)num;
		num >>= 32;
		num += (long)IGNEOOOFEMO[NDAAKFPMLOL + 7] - (long)AMFCENFNAJJ[ABBPDEOGNFE + 7];
		IGNEOOOFEMO[NDAAKFPMLOL + 7] = (uint)num;
		num >>= 32;
		return (int)num;
	}
	...
	public static BigInteger DOJBPIFPALJ(uint[] AMFCENFNAJJ)
	{
		...
		for (int i = 0; i < 8; i++)
		{
			...
			if (num != 0)
			{
				PGOKFBKEOAB.MPMAFPANDLC(num, array, 7 - i << 2);
			}
		}
	...
	public static BigInteger CLJANJOEBFJ(ulong[] AMFCENFNAJJ)
	{
		...
		for (int i = 0; i < 4; i++)
		{
			...
			if (num != 0)
			{
				PGOKFBKEOAB.LHKOONEHKNH(num, array, 3 - i << 3);
			}
		}
		return new BigInteger(1, array);
	}
