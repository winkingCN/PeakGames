...
namespace Dialogs
{
	public class CLLeaderboardEntry : VerticalScrollEntry
	{
		...
		public GameObject InventoryReward;
		...
		public override void SetContent<T>(T IFLICJGCCNM)
		{
			...
			if (bDELNAHPDFB.OHAPPDGAKNG < 4)
			{
				...
				bool flag2 = bDELNAHPDFB.BIEIJGOBEIA > 0;
				ENIHNAEFMNK(CoinsRewards[0], flag2 && num == 0);
				ENIHNAEFMNK(CoinsRewards[1], flag2 && num == 1);
				ENIHNAEFMNK(CoinsRewards[2], flag2 && num == 2);
				if (flag2)
				{
