...
public class BGHAMOMOAPG : BIMAONBKNOP
{
	...
	public override void DIOELAHNLKJ(TutorialManager NGIFIPBOMBO)
	{
		...
		EEABKKPJAOO = new string[2] { "Tutorial_0010_1", "Tutorial_Fun_0010_2" };
	}
	...
	public override void GDGINCNCMDD(Cell BBJPFHPBOHC)
	{
		try
		{
			...
			case 1:
			{
				...
				CGECKLIKPGE.ShowDialog(NKILHODNBDE.GHBGCADFLFB(EEABKKPJAOO[JCLBCFCCPGG - 1]), new float[2] { 3.5f, 1.7f }, false);
			...
			case 2:
			{
				...
				CNFHIFJHOBL = false;
				CGECKLIKPGE.ShowDialog(NKILHODNBDE.GHBGCADFLFB(EEABKKPJAOO[JCLBCFCCPGG - 1]), new float[2] { 3.5f, 3f }, false);
