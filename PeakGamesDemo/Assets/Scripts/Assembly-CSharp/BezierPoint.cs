...
public class BezierPoint : MonoBehaviour
{
	...
	public KPKGNOMFABP handleStyle;
	...
	public Vector3 handle1
	{
		...
		set
		{
			...
			{
				_handle1 = value;
				if (handleStyle == KPKGNOMFABP.None)
				{
					handleStyle = KPKGNOMFABP.Broken;
				}
				else if (handleStyle == KPKGNOMFABP.Connected)
				{
					_handle2 = -value;
				}
				_curve.SetDirty();
